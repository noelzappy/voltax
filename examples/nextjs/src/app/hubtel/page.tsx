...
export default function HubtelPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/hubtel/create-payment", {
        method: "POST",
      ...
      if (data.success && data.authorizationUrl) {
        ...
        localStorage.setItem("lastPaymentProvider", "hubtel");
    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <h1 className={styles.title}>Hubtel</h1>
          <p className={styles.subtitle}>Ghana Mobile Money</p>
        </div>
