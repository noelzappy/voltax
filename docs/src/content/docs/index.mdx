...
<CardGrid stagger>
  ...
  <Card title="Initialize Payments" icon="rocket">
    Learn how to [create and manage payments](/guides/payments/) with any provider.
  </Card>
  <Card title="Handle Errors" icon="warning">
    Implement robust [error handling](/guides/error-handling/) for production apps.
  </Card>
  <Card title="API Reference" icon="open-book">
    Explore the complete [API documentation](/reference/) with all classes, interfaces, and types.
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="Paystack" icon="seti:config">
    Integrate [Paystack payments](/guides/paystack/) with channels, splits, and subscriptions.
  </Card>
  <Card title="Flutterwave" icon="seti:config">
    Set up [Flutterwave payments](/guides/flutterwave/) with customization and subaccounts.
  </Card>
  <Card title="Hubtel" icon="seti:config">
    Configure [Hubtel payments](/guides/hubtel/) for Ghana with mobile money support.
  </Card>
